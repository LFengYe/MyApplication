package lfeng.com.imdeveloper.ui.activity.shop;
 ...
 *
 */
public class TTCustomTipsView extends IMChatBaseCustomView{
	...
	public TTCustomTipsView(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
	}

	public TTCustomTipsView(Context context) {
		super(context);
		mContext = context;
	}
	
	public TTCustomTipsView(Context context, AttributeSet attrs, int defStyle) {
	...
	protected int setLayout() {
		//设置布局xml
		return R.layout.tt_chatview_item_custom_view_2;
	}
