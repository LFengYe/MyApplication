...
import lfeng.com.imdeveloper.ui.view.gridview.GroupInfoAdapter;
import lfeng.com.imdeveloper.ui.view.gridview.MyGridView;
...
public class GroupInfoActivity extends Activity implements OnClickListener{
	...
	private OnClickListener removeMemberListener = new OnClickListener() {
	...
	private void showGroupNameOrInfoDialog(final String updateName) {
		Builder builder = new Builder(GroupInfoActivity.this);
