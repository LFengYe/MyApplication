 ...
 *******************************************************************************/
package lfeng.com.imdeveloper.ui.view.pulltorefresh.internal;
...
import lfeng.com.imdeveloper.ui.view.pulltorefresh.ILoadingLayout;
import lfeng.com.imdeveloper.ui.view.pulltorefresh.PullToRefreshBase.Mode;
import lfeng.com.imdeveloper.ui.view.pulltorefresh.PullToRefreshBase.Orientation;
...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
	...
	public LoadingLayout(Context context, final Mode mode,
		...
		if (attrs.hasValue(R.styleable.PullToRefresh_ptrSubHeaderTextAppearance)) {
			TypedValue styleID = new TypedValue();
			attrs.getValue(R.styleable.PullToRefresh_ptrSubHeaderTextAppearance,
					styleID);
