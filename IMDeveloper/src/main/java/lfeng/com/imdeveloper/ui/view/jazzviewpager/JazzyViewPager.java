package lfeng.com.imdeveloper.ui.view.jazzviewpager;
...
public class JazzyViewPager extends ViewPager {
	...
	private View wrapChild(View child) {
		...
		out.addView(child);
//		out.setFadeEnabled(true);
//		out.setPageMargin(30);
//		out.setSlideCallBack(new JazzyViewPager.SlideCallback() {
//		@Override
//		public void callBack(int position, float positionOffset) {
//			out.itemChangeChecked(position, positionOffset);
//		}
//	});
		return out;
	}
