package lfeng.com.imdeveloper.ui.view;
...
public class CustomRadioGroup extends LinearLayout {
	...
	// 条目列表
	private List<RadioButton> mRadioBtnsList = new ArrayList<RadioButton>();
	...
	private class RadioButton {
		...
		void setNewsCount(int count) {
			if (count < 0) {
				...
				RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) mNewsTextView
						.getLayoutParams();
