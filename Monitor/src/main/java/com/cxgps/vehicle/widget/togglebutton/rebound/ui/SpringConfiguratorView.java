...
package com.cxgps.vehicle.widget.togglebutton.rebound.ui;
...
import com.cxgps.vehicle.widget.togglebutton.rebound.OrigamiValueConverter;
import com.cxgps.vehicle.widget.togglebutton.rebound.Spring;
import com.cxgps.vehicle.widget.togglebutton.rebound.SpringConfig;
import com.cxgps.vehicle.widget.togglebutton.rebound.SpringConfigRegistry;
import com.cxgps.vehicle.widget.togglebutton.rebound.SpringListener;
import com.cxgps.vehicle.widget.togglebutton.rebound.SpringSystem;
...
public class SpringConfiguratorView extends FrameLayout {
   ...
   */
  @TargetApi(Build.VERSION_CODES.HONEYCOMB) private View generateHierarchy(Context context) {
    Resources resources = getResources();
    ...
    params =  Util.createLayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,  Util.dpToPx(300, resources));
    root.setLayoutParams(params);
      ...
      root.addView(container);
        ...
        params =  Util.createMatchWrapParams();
        params.setMargins(0, 0, 0,  Util.dpToPx(80, resources));
        ...
        container.addView(linearLayout);
          ...
          linearLayout.addView(seekWrapper);
            ...
            params =  Util.createLayoutParams(
          ...
          linearLayout.addView(seekWrapper);
            ...
            params =  Util.createLayoutParams( Util.dpToPx(50, resources), ViewGroup.LayoutParams.MATCH_PARENT);
      ...
      params =  Util.createLayoutParams( Util.dpToPx(60, resources),  Util.dpToPx(40, resources));
