...
import com.cxgps.vehicle.widget.wheel.NumericWheelAdapter;
import com.cxgps.vehicle.widget.wheel.OnWheelChangedListener;
import com.cxgps.vehicle.widget.wheel.WheelView;
...
public class BirthDateDialog extends Dialog implements
	...
	public interface PriorityListener {
		...
		public void refreshPriorityUI(String year, String month, String day,
									  String hours, String mins, String second);
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.view_dialog_date_wheel);
